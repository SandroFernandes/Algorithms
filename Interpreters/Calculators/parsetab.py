...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','calc.py',57),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','calc.py',82),
  ('expression -> ( expression )','expression',3,'p_expression_group','calc.py',87),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',92),
  ('expression -> NAME','expression',1,'p_expression_name','calc.py',97),
]
